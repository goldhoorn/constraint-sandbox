...
;goldhoorn@mgoldhoorn:~/dev-avalon-21/bundles/diss$ time pddl_planner_bin -t 600 -p FDAUTOTUNE2 domain.pddl diss-esamples/problem_large_unsolveable.pddl 
;/home/goldhoorn/dev-avalon-21/install/bin/fast_downward-planner
;keine ergebnissse für: 
;FDAUTOTUNE1
;FDAUTOTUNE2
;FDSS1
;FDSS2
